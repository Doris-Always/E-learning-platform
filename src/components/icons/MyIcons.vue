...
<svg v-if="name === 'book'" :class="{ 'icon-default': !isActive, 'icon-active': isActive }" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
